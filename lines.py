...
root = os.getcwd()
shields = ["node_modules", "dependencies", "lib", ".json", "dist"]
lines = 0
sizes = 0
same = root
...
def help():
	print("\033[1m\033[37mSword Data Statistics Tool\033[0m")
...
def version():
	print("\033[1m\033[37mSword Data Statistics Tool \033[35mv-1.0.0\033[0m")
	print("\033[1m\033[37mCopyright yhzheng (c) 2019\033[0m")
